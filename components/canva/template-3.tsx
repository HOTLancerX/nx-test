...
export default function Template3({ data, styles, parseTitle }: TemplateProps) {
  ...
  return (
    <div className="relative w-full h-full flex flex-col p-8 overflow-hidden" style={backgroundStyle}>
      {data.images && (
        <img
      ...
      <div className="relative z-10 text-white flex flex-col h-full">
        ...
        <div className="flex items-center justify-between text-sm mt-auto">
          <p style={{ color: styles.dateColor }}>{data.date}</p>
